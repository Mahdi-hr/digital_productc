    ...
    username = models.CharField(
        ...
        validators=[
            validators.RegexValidator(
                r'^[a-zA-Z][a-zA-Z0-9_.]+$',
                'Enter a valid username starting with a letter. This value may contain only letters, numbers, and underscore characters.'
            ),
        ],
        error_messages={
...
class UserProfile(models.Model):
    ...
    gender = models.BooleanField('gender',null=True,blank=True,help_text='female is False, male is True, null is unset')
